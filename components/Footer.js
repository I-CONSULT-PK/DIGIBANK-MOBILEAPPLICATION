      ...
      <View className="h-14 flex flex-row items-center justify-center">
        <View className="flex flex-row justify-center space-x-7">
          <View className=" items-center">
            <Ionicons
              ...
              size={27}
            />
            <Text className="font-InterMedium text-white">Chat</Text>
          </View>
          <View className=" items-center">
            <Fontisto
              name="shopping-sale"
              ...
              size={27}
            />
            <Text className="font-InterMedium text-white">Discount</Text>
          </View>
        </View>
        ...
        <View className="items-center justify-center">
                        <Ionicons
                            ...
                            size={27}
                        />
                        <Text className="font-InterMedium text-white">Setting</Text>
                    </View>
                    <View className=" items-center justify-end ">
                        <Feather
                            ...
                            size={27}
                        />
                        <Text className="font-InterMedium text-white">Logout</Text>
                    </View>
        </View>
      </View>
    </LinearGradient>
