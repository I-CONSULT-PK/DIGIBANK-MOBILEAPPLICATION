...
const SplashScreen = ({ navigation }) => {
  ...
  return (
      <LinearGradient
        ...
        <Text className='font-InterBlack  -m-14' style={{fontSize:267, color:Color.PrimaryWebOrientTxtColor}}>Z</Text>
        <Text className='font-medium text-white text-xl'>Ultimate Banking Solution</Text>
      </LinearGradient>
  )
}
